...
const userSchema = new mongoose.Schema({
  ...
  lastSeenTime:{ type: Date,    default: null },   // ← renamed (was lastSeen Date)
  fcmToken:    { type: String,  default: "" },
  createdAt:   { type: Date,    default: Date.now },
  bio:         { type: String,  default: "Hey there! I am using ZunO" },
 
  lastSeenTime:    { type: Date,    default: null },      // ← lastSeen rename
...
const groupSchema = new mongoose.Schema({
  ...
  createdAt:           { type: Date,    default: Date.now },
  exceptList:  { type: [String], default: [] },  // contacts except
  allowedList: { type: [String], default: [] },  // only share with
